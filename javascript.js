...
function removeAllActual (){
	...
	//document.getElementById(z).classList.remove('vis');
	//document.getElementById(z).classList.add('inv');
	//document.getElementById(z).innerHTML = '';
	console.log(z.length);
	for(var t = 0; t < z.length; t++){
		document.getElementById(z[t].value).classList.remove('vis');
		document.getElementById(z[t].value).classList.add('inv');
